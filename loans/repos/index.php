...
<div class="container">
    ...
    <div class="innerR">
    <div class="top" align="right"><? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "search.html"); ?></div>
...
&bull; <a href="../../calculators/index.php">Loan Payment Calculators</a></p>
    ...
    <div class="innerC1">
      ...
      <table border="1" cellpadding="4" cellspacing="0" align="center" width="95%" bordercolor="#999999">
        <tr class="contenttext"><td width="15%" align="center" bgcolor="#FFFFFF">PICTURE</td><td width="9%" align="center" bgcolor="#FFFFFF">YEAR</td><td width="22%" align="center" bgcolor="#FFFFFF">MAKE AND MODEL</td><td width="13%" align="center" bgcolor="#FFFFFF">PRICE</td><td width="13%" align="center" bgcolor="#FFFFFF">MILEAGE</td>
      <td width="28%" align="center" bgcolor="#FFFFFF">DESCRIPTION</td></tr>
    </table>
      <table border="0" cellpadding="4" cellspacing="0" align="center" width="95%">
		  <tr><p><strong>There Are Currently No Vehicles For Sale</strong></p></tr>
      <!--  <tr class="contenttext">
          <td width="15%" align="center" valign="top" bgcolor="#FFFFFF"><a href="#dialog7" name="modal" id="modal7"><br />
            <img src="pics/2020/2015GL550.png" alt="2015 Mercedes-Benz GL550" width="100" height="50" /><br />
            Click to enlarge</a></td>
          <td width="9%" align="center" valign="top" bgcolor="#FFFFFF">2015</td>
          <td width="22%" align="left" valign="top" bgcolor="#FFFFFF">Mercedes-Benz GL550</td>
          <td width="13%" align="center" valign="top" bgcolor="#FFFFFF">$29,000.00</td>
          <td width="13%" align="center" valign="top" bgcolor="#FFFFFF">138,350 mi</td>
          <td width="28%" align="center" valign="top" bgcolor="#FFFFFF"><a href="pdf/2015MercedesGL550.pdf" target="_blank">Click for Flyer</a></td>
        </tr> -->
        <tr class="contenttext">
          <td colspan="6" align="center" valign="top" bgcolor="#FFFFFF"><hr /></td>
        </tr>
      </table>
    </div>
    ...
    <div class="footer"><? $INC_DIR = $_SERVER["DOCUMENT_ROOT"]. "/"; include($INC_DIR. "footer.html"); ?></div>
</div>
	<div id="boxes">
...
<strong>2012 Chevrolet Tahoe LTZ</strong></p>
</div>
...
<strong>2014 Buick Enclave</strong></p>
</div>
...
<strong>2013 Lexus GS350</strong></p>
</div>
